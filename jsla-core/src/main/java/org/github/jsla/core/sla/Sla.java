 ...
 * <ul>
 * <li>a transaction <b>rate</b>, which is the number of allowed transactions in a
 * given time interval. Can be seen as a limitation in frequency.</li>
 * <li>a <b>quota</b>, which is the number of total transactions allowed in a time
 * interval. Usually this time interval is bigger than the one expressed in the
 * transaction rate. Can be seen as a limitation if quantity.</li>
 * </ul>
 * </p>
 * 
 * <p>
...
public class Sla {
     ...
     * 
     * @param rate the SLA rate
     * @param quota the SLA quota
     */
