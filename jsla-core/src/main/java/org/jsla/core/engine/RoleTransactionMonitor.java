...
/**
 * 
 * Role based enforcement of a SLA monitor. Users without a role will use a special rate control, for no-role or anonymous access.
 * 
 * @author Alin Vasile
 * @since 1.0
 *
...
public class RoleTransactionMonitor implements AccessMonitor {
	...
	/**
	 * Adds a role name SLA. If multiple SLAs have the same priority, they will be verified
	...
	/**
	 * Adds an anonymous SLA. This SLA will be used for anonymous users or users without any roles.
	 * 
	 * @param sla
	 *            the SLA to add.
	 */
